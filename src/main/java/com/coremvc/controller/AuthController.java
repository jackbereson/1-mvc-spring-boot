...
import com.coremvc.dto.RefreshTokenRequest;
...
public class AuthController {
     ...
     * @throws com.coremvc.exception.UnauthorizedException if refresh token is invalid or expired
     */
    @PostMapping("/refresh")
     ...
     * @throws com.coremvc.exception.UnauthorizedException if user not authenticated or not found
     */
    @GetMapping("/me")
